      ...
      <div className="flex flex-col justify-center items-center bg-slate-100 flex-wrap min-h-screen relative">
        <div className="flex flex-col gap-5 items-center justify-center m-5">
          ...
          <p className="lg:w-2/3">
            ESAMAN is a national logistic and courier company with largest
            domestic distribution network in the country. We let you to exercise
            full control and visibility of your packages through dedicated
            Relationship Managers (RMs) and Self-Service Portals (SSP).
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-5 lg:w-2/3">
          <div className="bg-white flex flex-col w-80 gap-4 p-5 hover:shadow-lg transition delay-150">
            ...
            <p>
              We work closely with our partner freight forwarders to bring any
              cargo merchandise from anywhere in the world to Nepal.
            </p>
          </div>
          <div className="bg-white flex flex-col w-80 gap-4 p-5 hover:shadow-lg transition delay-150">
            ...
            <p>
              We provide complex logistics management that includes warehousing,
              inventory control, cold chain, project logistics, aid delivery,
              etc.
            </p>
          </div>
          <div className="bg-white flex flex-col w-80 gap-4 p-5 hover:shadow-lg transition delay-150">
            ...
            <p>
              We operate our own fleet to provide a range of reliable transport
              & trucking staff, vehicles and solutions that meet your business
              needs.
            </p>
          </div>
          <div className="bg-white flex flex-col w-80 gap-4 p-5 hover:shadow-lg transition delay-150">
